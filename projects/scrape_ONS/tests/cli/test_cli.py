...
from ons_data.cli import setup_parser, validate_args, create_config, ensure_output_dir, main
...
class TestCLI:
    ...
    def test_main_function(self, mock_configure_logging, mock_download,
                          mock_ensure_dir, mock_create_config,
                          mock_validate_args, mock_setup_parser):
